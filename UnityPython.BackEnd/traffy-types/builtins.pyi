...
# Unity Python extensions

class Task:
    Yield: Coroutine[None, None, None]
...
class ref(Generic[_T]):
    ...
    def __init__(self, obj: _T | None=None) -> None: ...
...
#     @overload
#     def send(self, __value: _T_contra, found: ref[_T_co]) -> bool: ...
#     # @overload
#     # @abstractmethod
#     # def throw(
...
class object:
    ...
    def __getattr__(self, __name: str, __attr: str) -> None: ...
    def __findattr__(self, __name: str, __attr: str, v: ref) -> bool: ...
...
#     ) -> Self: ...
    ...
    def __floordiv__(self, __x: int | float) -> int: ...
    def __truediv__(self, __x: int | float) -> float: ...
    @overload
    def __mod__(self, __x: int) -> int: ...
    @overload
    def __mod__(self, __x: float) -> int: ...
...
#     def __pow__(self, __x: int, __modulo: Literal[0]) -> NoReturn: ...
    ...
    # __modulo: None = ...) -> Literal[1]: ...
    @overload
    def __pow__(self, __x: _PositiveInteger) -> int: ...
    # , __modulo: None = ...) -> int: ...
    @overload
    def __pow__(self, __x: _NegativeInteger) -> float: ...
    # , __modulo: None = ...) -> float: ...

    # positive x -> int; negative x -> float
    # return type must be Any as `int | float` causes too many false-positive errors
    @overload
    def __pow__(self, __x: int) -> Any: ...
    # , __modulo: None = ...) -> Any: ...
...
#     def __divmod__(self, __x: float) -> tuple[float, float]: ...
    ...
    @overload
    def __pow__(self, __x: int) -> float: ...
    @overload
    def __pow__(self, __x: float) -> float: ...
    # @overload
...
class list(MutableSequence[_T], Generic[_T]):
    ...
    # def map(self, __f: Callable[[_T], _S]) -> list[_S]: ...
