...
namespace IronPython.Runtime {
    ...
    internal sealed class NewStringFormatter {
        ...
        /// </summary>
        public static string/*!*/ FormatString(PythonContext/*!*/ context, string/*!*/ format, Traffy.Objects.TrObject[]/*!*/ args, Traffy.Objects.TrObject/*!*/ kwArgs) {
        ...
        private struct StringFormatParser {
            ...
            /// </summary>
            public static IEnumerable<(string, string, string, string)/*!*/>/*!*/ Parse(string/*!*/ text) {
            ...
            ///     the conversion
            /// </summary>
            private IEnumerable<(string, string, string, string)/*!*/>/*!*/ Parse() {
                int lastTextStart = 0;
            ...
            private (string, string, string, string)/*!*/ ParseFormat(int lastTextStart) {
        ...
        private class Formatter {
            ...
            private readonly Traffy.Objects.TrObject[]/*!*/ _args;
            private readonly Traffy.Objects.TrObject/*!*/ _kwArgs;
            private int _depth;
            private int _autoNumberedIndex;

            private Formatter(PythonContext/*!*/ context, Traffy.Objects.TrObject[]/*!*/ args, Traffy.Objects.TrObject/*!*/ kwArgs) {
            ...
            private string ReplaceText(string format) {
                ...
                foreach ((string, string, string, string) pt in StringFormatParser.Parse(format)) {
                    string text = pt.Item1;
                    string fieldName = pt.Item2;
                    string formatSpec = pt.Item3;
                    string conversionStr = pt.Item4;
                    ...
                    if (fieldName != null) {
                        ...
                        Traffy.Objects.TrObject argValue = GetArgumentValue(ParseFieldName(fieldName, true));
            ...
            /// </summary>
            private Traffy.Objects.TrObject GetArgumentValue(FieldName fieldName) {
            ...
            /// specified.
            /// </summary>
            private Traffy.Objects.TrObject ApplyConversion(char? conversion, Traffy.Objects.TrObject argValue) {
                switch (conversion) {
                    case 'a':
                        argValue = PythonOps.BoxString(PythonOps.Ascii(_context.SharedContext, argValue));
                        break;
                    case 'r':
                        argValue = PythonOps.BoxString(PythonOps.Repr(_context.SharedContext, argValue));
                        break;
                    case 's':
                        return PythonOps.BoxString(PythonOps.ToString(_context.SharedContext, argValue));
                    case null:
            ...
            /// keyword name.
            /// </summary>
            private Traffy.Objects.TrObject GetUnaccessedObject(FieldName fieldName) {
                int argIndex;
                Traffy.Objects.TrObject argValue;
                ...
                if (fieldName.ArgumentName.Length == 0) {
                    ...
                    argValue = _kwArgs.__getitem__(PythonOps.BoxString(fieldName.ArgumentName));
                }
            ...
            /// </summary>
            private Traffy.Objects.TrObject DoAccessors(FieldName fieldName, Traffy.Objects.TrObject argValue) {
                foreach (FieldAccessor accessor in fieldName.Accessors) {
                    ...
                    if (accessor.IsField) {
                        ...
                        argValue = PythonOps.GetIndex(
                            _context.SharedContext,
                            argValue,
                            PythonOps.BoxString(accessor.AttributeName)
                        );
                    }
                }
