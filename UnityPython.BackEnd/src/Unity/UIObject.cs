...
{
    //     public static void set_font_size(GameObject o, DObj i)
    //     {
    //         var text = o.GetComponent<Text>();
    //         if (text != null)
    //         {
    //             text.fontSize = (int)((DInt)i).value;
    //             return;
    //         }
    //         var tmp = o.GetComponent<TMPro.TextMeshProUGUI>();
    //         if (tmp != null)
    //         {
    //             tmp.fontSize = (int)((DInt)i).value;
    //             return;
    //         }
    //         // TODO: warning
    //     }

    //     public static DObj get_font_size(GameObject o)
    //     {
    //         var text = o.GetComponent<Text>();
    //         if (text != null)
    //         {
    //             return MK.Int(text.fontSize);
    //         }

    //         var tmp = o.GetComponent<TMPro.TextMeshProUGUI>();
    //         if (tmp != null)
    //         {
    //             return MK.Int((int)tmp.fontSize);
    //         }
    //         throw new ValueError($"{o.name} has no fontsize");
    //         // TODO: warning
    //     }

    //     public static void set_text_contents(GameObject o, DObj s)
    //     {
    //         var text = o.GetComponentInChildren<Text>();
    //         if (text != null)
    //         {
    //             text.text = ((DString)s).value;
    //         }
    //         // TODO: warning
    //     }

    //     public static void set_tmp_contents(GameObject o, DObj s)
    //     {
    //         var text = o.GetComponentInChildren<TMPro.TextMeshProUGUI>();
    //         if (text != null)
    //         {
    //             text.text = ((DString)s).value;
    //         }
    //     }
    //     public static DObj get_text_contents(GameObject o)
    //     {
    //         var text = o.GetComponentInChildren<Text>();
    //         if (text != null)
    //         {
    //             return MK.String(text.text);
    //         }
    //         return DNone.unique;
    //     }

    //     public static DObj get_tmp_contents(GameObject o)
    //     {
    //         var text = o.GetComponentInChildren<TMPro.TextMeshProUGUI>();
    //         if (text != null)
    //         {
