...
{
    public sealed partial class TrBytes
    {
        internal static void generated_BindMethods()
        {
                ...
                switch(__args.Count)
                {
                    case 1:
                    {
                        ...
                        if (((__kwargs != null) && __kwargs.TryGetValue(MK.Str("encoding"),out var __keyword__2)))
                            ...
                            _2 = null;
                        return Box.Apply(Traffy.Objects.TrBytes.__new__(_0,buffer : _1,encoding : _2));
                    }
                    case 2:
                    {
                        var _0 = Unbox.Apply(THint<Traffy.Objects.TrObject>.Unique,__args[0]);
                        ...
                        if (((__kwargs != null) && __kwargs.TryGetValue(MK.Str("encoding"),out var __keyword__2)))
                            ...
                            _2 = null;
                        return Box.Apply(Traffy.Objects.TrBytes.__new__(_0,_1,encoding : _2));
                    }
                    case 3:
                    {
                        var _0 = Unbox.Apply(THint<Traffy.Objects.TrObject>.Unique,__args[0]);
                        ...
                        return Box.Apply(Traffy.Objects.TrBytes.__new__(_0,_1,_2));
                    }
                    default:
            ...
            static  Traffy.Objects.TrObject __bind_fromhex(BList<TrObject> __args,Dictionary<TrObject,TrObject> __kwargs)
            {
                switch(__args.Count)
                {
                    case 1:
                    {
                        ...
                        return Box.Apply(Traffy.Objects.TrBytes.fromhex(_0));
                    }
                    default:
            ...
            static  Traffy.Objects.TrObject __bind_count(BList<TrObject> __args,Dictionary<TrObject,TrObject> __kwargs)
            {
                switch(__args.Count)
                {
                    case 2:
                    {
                        var _0 = Unbox.Apply(THint<Traffy.Objects.TrBytes>.Unique,__args[0]);
                        var _1 = Unbox.Apply(THint<Traffy.Objects.TrObject>.Unique,__args[1]);
                        System.Int32 _2;
