...
namespace Traffy.Unity2D
{
    public sealed partial class TrRawImage
    {
        internal static void generated_BindMethods()
        {
            ...
            CLASS["requireComponents"] = TrSharpFunc.FromFunc(CLASS.Name + "." + "requireComponents", (self, args, kwargs) => ((TrRawImage) self)._RequireComponents(args, kwargs));
            ...
            {
                return Box.Apply(((Traffy.Unity2D.TrRawImage)_arg).ui);
            }
