...
{
    public sealed partial class TrVector2
    {
        internal static void generated_BindMethods()
        {
            static  Traffy.Objects.TrObject __bind___new__(BList<TrObject> __args,Dictionary<TrObject,TrObject> __kwargs)
            {
                switch(__args.Count)
                {
                    case 2:
                    {
                        ...
                        return Box.Apply(Traffy.Unity2D.TrVector2.__new__(_0,_1));
                    }
                    default:
            ...
            static  Traffy.Objects.TrObject __bind_tovec3(BList<TrObject> __args,Dictionary<TrObject,TrObject> __kwargs)
            {
                switch(__args.Count)
                {
                    case 1:
                    {
                        var _0 = Unbox.Apply(THint<Traffy.Unity2D.TrVector2>.Unique,__args[0]);
                        return Box.Apply(_0.tovec3());
                    }
                    default:
                        throw new ValueError("tovec3() requires 1 positional argument(s), got " + __args.Count);
                }
            }
            CLASS["tovec3"] = TrSharpFunc.FromFunc("tovec3", __bind_tovec3);
            static  Traffy.Objects.TrObject __read_x(Traffy.Objects.TrObject _arg)
            {
                return Box.Apply(((Traffy.Unity2D.TrVector2)_arg).x);
            }
            static  void __write_x(Traffy.Objects.TrObject _arg,Traffy.Objects.TrObject _value)
            {
                ((Traffy.Unity2D.TrVector2)_arg).x = Unbox.Apply(THint<Traffy.Objects.TrObject>.Unique,_value);
            }
            ...
            {
                return Box.Apply(((Traffy.Unity2D.TrVector2)_arg).y);
            }
            static  void __write_y(Traffy.Objects.TrObject _arg,Traffy.Objects.TrObject _value)
            {
                ((Traffy.Unity2D.TrVector2)_arg).y = Unbox.Apply(THint<Traffy.Objects.TrObject>.Unique,_value);
            }
