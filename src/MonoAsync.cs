...
{
    [NotNull] internal MonoAsync<TElement> top;
...
public sealed partial class MonoAsync<TElement> : INotifyCompletion
{
    ...
    [AllowNull] internal Handler<TElement> m_handler;
    public bool IsCompleted => m_IsCompleted;


    [MethodImpl(MethodImplOptionsCompat.Best)]
    public TElement GetResult() => m_Result;
    ...
    [MethodImpl(MethodImplOptionsCompat.Best)]
    public void YieldFrom([AllowNull] Handler<TElement> handler)
    {
    ...
    [MethodImpl(MethodImplOptionsCompat.Best)]
    public bool MoveNext([AllowNull] Handler<TElement> handler)
    {
        if (m_IsCompleted)
            return false;
        if (m_Nested == null)
